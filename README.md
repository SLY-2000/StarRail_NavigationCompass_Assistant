...
## 使用示例：
仙舟引航罗盘
![罗盘示例](https://github.com/SLY-2000/StarRail_NavigationCompass_Assistant/Compass_Example.png)

图中的罗盘均为逆时针旋转，因此离终点距离格子数均为2
![使用示例](https://github.com/SLY-2000/StarRail_NavigationCompass_Assistant/Executable_Example.png)
